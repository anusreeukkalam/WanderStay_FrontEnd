...
export default function BookingPage() {
    ...
    return (
        <div>
            ...
            <div className=" flex items-center gap-4 bg-gray-200 dark:bg-gray-800 p-4 my-6 rounded-2xl justify-between border border-transparent dark:border-gray-700">
                <div >
                    <h1 className="text-xl lg:text-2xl mx-3 mt-2 mb-3 font-semibold font-style: italic dark:text-gray-100" >{booking.place.title}</h1>
                ...
                <div className=" bg-primary text-lg font-semibold text-white rounded-xl p-3 text-center mr-3 " style={{ backgroundColor: '#9F0D7F' }}>
